...
from PyQt6.QtWidgets import QApplication, QMainWindow, QLabel, QLineEdit, QComboBox, QPushButton, QCheckBox
...
def make_request_search(geocode, obj):
    link = '[https://search-maps.yandex.ru/v1/](https://search-maps.yandex.ru/v1/)'
    params = {
        'lang': 'ru_RU',
...
class Example(QMainWindow):
    ...
    def initUI(self):
        ...
        def get_image(self, coords, scale):
            ...
            link = '[http://static-maps.yandex.ru/1.x/](http://static-maps.yandex.ru/1.x/)'
        ...
        def left_mouse_click(self, event):
            ...
            if self.scale < 8:
                self.statusBar().showMessage(
                    f'Использование меток при масштабе от 8, '
                    f'масштаб: {self.scale}')
                return
